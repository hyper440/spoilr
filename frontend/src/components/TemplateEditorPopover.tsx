...
export default function TemplateEditor({ template, onTemplateChange, onResetToDefault }: TemplateEditorProps) {
  ...
  const templateParams: TemplateParam[] = [
    ...
    { name: "%VIDEO_FPS%", description: "Video framerate in decimal format (e.g., 59.940)" },
    { name: "%VIDEO_FPS_FRACTIONAL%", description: "Video framerate in fractional format (e.g., 60000/1001)" },
    { name: "%AUDIO_SAMPLE_RATE%", description: "Audio sample rate (e.g., 44.1 kHz)" },
    { name: "%AUDIO_CHANNELS%", description: "Audio channel count (e.g., 2 channels)" },
